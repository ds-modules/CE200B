...
def BINS(Nx:int,Ny:int,Lx:float,Ly:float,dt:float,T:float,BC:float,IC_choice:int,nu:float,ng:int, PGx:float, PGy:float, IBM:int):
  ...
  #  #plot intermediate results at increments defined by dt
        if ii == ii0:
            u0=u
            v0=v
            t0=t
    ...
    np.savez('quarterly_arrays.npz', t0=t0, u0=u0, v0=v0, t1=t1, u1=u1, v1=v1, t2=t2, u2=u2, v2=v2, t3=t3, u3=u3, v3=v3)